...
redirects = A1 -> redirect[[Difficulty scale#A1]]; A2 -> redirect[[Difficulty scale#A2]]; B1 -> redirect[[Difficulty scale#B1]]; B2 -> redirect[[Difficulty scale#B2]]; C1 -> redirect[[Difficulty scale#C1]]; C2 -> redirect[[Difficulty scale#C2]]; CEFR -> redirect[[Difficulty scale]]; Levels -> REDIRECT [[Difficulty scale]]
---
