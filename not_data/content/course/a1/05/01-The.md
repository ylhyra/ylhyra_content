...
In English, the word "**the**" is a separate word ("**the** day"), while in Icelandic it is attached to the end of the word ("dagur**inn**"). It is known as the [[w:definite article|definite article]] and its form changes depending on the word's [[gender]], [[case]], and [[plurality]].

Understanding how to create the various forms of the definite article is easier if we think of it as its own separate word (which it more or less originally was before it merged with the word before it).<note>Those interested can see [https://doi.org/10.2478/v10122-009-0005-y
